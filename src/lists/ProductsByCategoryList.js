...
const ProductCard = ({ 
  ...
  return (
    <div className="bg-white border border-gray-300 rounded-2xl p-6 space-y-4 transform transition-all duration-300 hover:scale-105 hover:shadow-2xl group relative overflow-hidden">
      {/* Product Image */}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        {isInCart ? (
          <button
            ...
            className="flex items-center justify-center space-x-2 py-2 bg-orange-600 text-white rounded-full hover:bg-orange-700 disabled:opacity-50"
          >
  ...
  return (
    <div className="min-h-screen bg-white py-12 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto">
        <h1 className="text-5xl font-extrabold text-center mb-12 text-orange-500">
          Shop Products
        </h1>
